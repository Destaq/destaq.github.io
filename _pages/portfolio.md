...
gallery_bump:
    - url: /assets/images/portfolio/bump1.png
      image_path: /assets/images/portfolio/bump1.png
      alt: "bump screenshot 1"
      title: "bump screenshot 1"
    - url: /assets/images/portfolio/bump2.png
      image_path: /assets/images/portfolio/bump2.png
      alt: "bump screenshot 2"
      title: "bump screenshot 2"
    - url: /assets/images/portfolio/bump3.png
      image_path: /assets/images/portfolio/bump3.png
      alt: "bump screenshot 3"
      title: "bump screenshot 3"
---
...
Most such tools are in the full-stack webdev, NLP, or CLI domains, and are primary written in Python (Flask/vanilla), TypeScript (React/Svelte/Vue), and/or Golang. The source code for about a dozen complete projects is available on my [GitHub profile](https://github.com/Destaq){:target="_blank"}, and I've written up more detailed descriptions of a few of the best below.
...
My passion project from Oct '22 to Nov '23, [Lingotrack](https://www.lingotrack.com){:target="_blank"} *(50k+ SLOC, Golang + TypeScript + Svelte)* is a social platform for language learners to track progress and find engaging, level-appropriate media. By visualizing learners' achievements, allowing them to uncover captivating foreign content, and connecting them with fellow enthusiasts, the site hopes to make the journey to fluency a little less daunting.
...
You can find out more about Lingotrack on [the official about page](https://www.lingotrack.com/about){:target="_blank"} or by checking out [its well-received launch on Product Hunt](https://www.producthunt.com/posts/lingotrack){:target="_blank"}.
...
[ColdCraft.ai](https://coldcraft.ai){:target="_blank"} *(~10k SLOC, Flask + TypeScript + Svelte)* is a SaaS cold emailing Chrome extension with an associated dashboard that integrates with your resume, Google Calendar, Gmail, and LinkedIn to help you write hyperpersonalized cold emails in seconds. I built it with a buddy over several weeks freshman spring (SP '24).

The project won [LinkedIn and Cisco](https://cis.cornell.edu/about/outreach-events/boom-bits-our-minds/awards/boom-2024-award-recipients){:target="_blank"}'s corporate awards during Cornell's annual engineering showcase, and has received several investment and acquisition offers.
...
That said, notes are certainly still very helpful for homework, reinforcement, etc., and so I teamed up with a few likeminded new friends at [Canada's largest hackathon](https://hackthenorth2024.devpost.com/){:target="_blank"} to build an AI- and CV-powered note-taking tool that could take care of this heavy lifting for us. Our Next.js-, Flask-, and OpenAI-powered tool sits in on lectures, listening and taking summarized Markdown notes that you can later interact with and save. Additionally, gesture-set metaparameters such as summarization level, pausing, and expansion / collapsion of notes are also available.

Our efforts and all-nighters earned us [#1/43](https://devpost.com/software/notehacks-bsjdoi){:target="_blank"} for the *Best Use of Groq* track (a prominent LLM company).
...
You can view the hackathon submission on the Devpost page [here](https://devpost.com/software/surgelingo){:target="_blank"}, along with [a corresponding video](https://www.youtube.com/watch?v=lIIGpiJqbz0&ab_channel=SimonIlincev){:target="_blank"} and more detailed description. Equally, you can run it locally by forking the [backend](https://github.com/Destaq/surgelingo-backend){:target="_blank"} and [frontend](https://github.com/Destaq/surgelingo-backend){:target="_blank"} off Github.

### FindCircles

{% include gallery id="gallery_circles" layout="half" %}

[Circles](https://devpost.com/software/circles-8cfnod){:target="_blank"} *(~7k SLOC, Next.js + Supabase + Google Cloud)* is a web app for easy, spontaneous meetups within friend groups and connecting with new people, inspired by the experiences of my three project team teammates and me on Cornell's huge campus.
...
The tool won the Best Domain award ([findcircles.co](https://findcircles.co){:target="_blank"}) from the judges at Cornell's 2024 Big Red Hacks hackathon, and was a student-judge favorite (unfortunately the staff judges were too reminded of their work-related Google Calendars and scheduling 😅).
...
<div style="display: flex; flex-direction: row; align-items: flex-start; gap: 2.5rem; flex-wrap: wrap; margin: 2rem 0;">
  ...
  <div style="flex: 1 1 300px; min-width: 220px;">
    <p>
      <a href="https://gcalwrapped.com" target="_blank"><strong>GCal Wrapped</strong></a> is like Spotify Wrapped, but for your Google Calendar, and targeted specifically at students. I built it out over a couple of weeks in the Spring 2025 semester at Cornell, and grew it to 1000 users in &lt;24 hours and twice that in the first week.
    </p>
    <p>
      The web app is optimized for both mobile and desktop, and is built with TypeScript, Svelte, Supabase, a model pipeline using Gemini 2.5 Flash, and Google Cloud. It's chock-full of animations, funny AI insights, and shareable screens — try it out for free now at <a href="https://gcalwrapped.com" target="_blank">gcalwrapped.com</a>!
    </p>
  </div>
</div>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (container && container.tagName === "DIV") {
      container.classList.add("gcalwrapped-flex");
    }
  });
</script>
...
{% include gallery id="gallery_bump" %}

[Bump](https://downloadbump.com){:target="_blank"} is a location-based, real-time, and friend-focused social media app that I built with a good friend from Cornell. The tech stack is Swift, Express, TypeScript, PostgreSQL, and AWS. We incorporated as Bump Platforms LLC in Delaware, and received a $1000 non-dilutive venture capital grant from 1517 Fund to help pay for the significant compute costs required to properly run the app.

Impressive technical achievements include:

- Realtime messaging system using WebSockets
- Fully responsible for Nginx configuration, VM setup, and deployment
- Went from 0 to 40k+ LOC MVP in 3 months as a team of two full-time students
- Deployed to the App Store! Find us [there](https://apps.apple.com/us/app/bump-the-real-life-social-app/id6742332534){:target="_blank"}.
...
_A simpler, local-only version of [Lingotrack](https://www.lingotrack.com){:target="_blank"} that served as inspiration for said later iteration._
...
...and a lot more! Online Life Calendar is completely free, has several hundred users at the time of writing, and has personally proven to be a great resource for self-motivation and planning. Its source code can be found [here](https://www.github.com/Destaq/life-calendar){:target="_blank"}.
...
It even supports named files, such as `Dockerfile` or `Cakefile`. You can find out more by reading the `README.md` at [the repo](https://github.com/Destaq/language-statistics){:target="_blank"}, or downloading it yourself.
...
Putting everything together was a challenge, given some of the rather uncommon framework combinations I used to build the app, but [the end result](https://www.github.com/Destaq/linguakite){:target="_blank"} was of great help to the friend I'd built it for and taught me a lot along the way.
...
I put a lot of effort into this project, and [the latest release](https://github.com/Destaq/chess_graph){:target="_blank"} now allows players to choose their color, games file, shading, hover tips, etc.
...
Unfortunately, as I would soon find out, running a program like this in the background drained a good deal more battery than it saved. But working with the AppleScript programming language, resolving a pull request to support Linux, and all-around learning lots left me with a [finished product](https://github.com/Destaq/low-face-mode){:target="_blank"} (see [GIF](https://github.com/Destaq/low-face-mode/blob/master/data/sample.gif){:target="_blank"}) and very happy nonetheless.

## Conclusion

Above is a representative sample of my work, but if you want to see more, do head over to my [GitHub profile](https://www.github.com/Destaq){:target="_blank"} or shoot me an email!
